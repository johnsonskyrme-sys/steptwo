...
// ES Module exports for dynamic imports - Chrome extension compatible
if (typeof module !== 'undefined' && module.exports) {
  // Node.js environment
  module.exports = { runScrape, extractImagesFromPage, handlePagination };
} else if (typeof window !== 'undefined') {
  // Browser environment - make functions available for dynamic imports
  window.runScrape = runScrape;
  window.extractImagesFromPage = extractImagesFromPage;
  window.handlePagination = handlePagination;
  window.enhancedStartScraping = runScrape;
  
  // Create module-like exports for dynamic import compatibility
